...
public class AttendantImpl extends java.rmi.server.UnicastRemoteObject implements shopping.Attendant {
    ...
    public AttendantImpl(String nombreTienda,java.rmi.server.RMIClientSocketFactory rmicsf,java.rmi.server.RMIServerSocketFactory rmissf) throws java.rmi.RemoteException {
